...
// in projectflutter/test/presentation/viewmodels/cart_viewmodel_test.dart.
...
import 'package:projectflutter/domain/entities/order.dart' as _i4;
...
class MockOrderRepository extends _i1.Mock implements _i2.OrderRepository {
  ...
  @override
  _i3.Future<void> createOrder(_i4.Order? order) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<void> clearOrders() =>
      (super.noSuchMethod(
            Invocation.method(#clearOrders, []),
            returnValue: _i3.Future<void>.value(),
            returnValueForMissingStub: _i3.Future<void>.value(),
          )
          as _i3.Future<void>);
